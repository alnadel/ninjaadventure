...
public class MainThread extends Thread {
	...
	private MainPanelInterface gamePanel;
	...
	public MainPanelInterface getGamePanel() {
		return gamePanel;
	}

	public void setGamePanel(MainPanelInterface gamePanel) {
		this.gamePanel = gamePanel;
	}
	
	public MainThread(SurfaceHolder surfaceHolder, MainPanelInterface gamePanel) {
		super();
			...
			try {
				...
				synchronized (surfaceHolder) {
					...
					while (sleepTime < 0 && framesSkipped < MAX_FRAME_SKIPS) {
						...
						//this.menuPanel.update(); // update without rendering
